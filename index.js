...
app.get("/", async (req, res) => {
  try {
    ...
    const og_url = DEFAULT_FALLBACK_LINK;
...
function getHtml(payload) {
  const {
    og_image = 'https://fancall-static-public.s3.ap-south-1.amazonaws.com/FanCall//fan/profile/1753277436594_upload_1753277419425.jpg',
    og_type = "website",
    og_url = DEFAULT_FALLBACK_LINK,
    og_title = payload.og_title || "Fancall User",
    og_description = 'Welcome to Fancall, where you can connect with your favorite creators and influencers through personalized video calls.',
    link = "",
  } = payload;
...
<head>
    ...
    <meta property="fb:app_id" content="3206794056270638" />
